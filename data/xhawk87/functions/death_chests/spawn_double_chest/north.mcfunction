...
setblock ~ ~ ~ minecraft:chest[facing=west,type=left]{CustomName:"{\"text\":\"§rDeath Chest\"}"} destroy 
setblock ~ ~ ~-1 minecraft:chest[facing=west,type=right]{CustomName:"{\"text\":\"§rDeath Chest\"}"} destroy 

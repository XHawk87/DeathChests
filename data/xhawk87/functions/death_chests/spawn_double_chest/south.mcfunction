...
setblock ~ ~ ~ minecraft:chest[facing=east,type=left]{CustomName:"{\"text\":\"§rDeath Chest\"}"} destroy 
setblock ~ ~ ~1 minecraft:chest[facing=east,type=right]{CustomName:"{\"text\":\"§rDeath Chest\"}"} destroy 

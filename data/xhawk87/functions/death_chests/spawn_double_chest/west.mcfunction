...
setblock ~ ~ ~ minecraft:chest[facing=south,type=left]{CustomName:"{\"text\":\"§rDeath Chest\"}"} destroy 
setblock ~-1 ~ ~ minecraft:chest[facing=south,type=right]{CustomName:"{\"text\":\"§rDeath Chest\"}"} destroy 

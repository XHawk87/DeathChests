...
# If the tile the player is standing in is not air, try the block above instead
...
execute if score Pos temp matches 0 positioned ~ ~1 ~ run function xhawk87:death_chests/spawn_double_chest/head_height_air_only
